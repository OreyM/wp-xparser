...
require_once 'scripts/form_result.php';
?>
...
<section class="games-table">
    <table>
        ...
        <tbody>
        <?php $count = 1; ?>
        <?php foreach ($game as $gameID => $gameData): ?>
        <tr>
            <td><?php echo $count++; ?></td>
            <td><?php echo $gameData->game_id; ?></td>
            <td class="game-name"><?php echo html_entity_decode($gameData->game_name); ?></td>
            ...
            <td class="check-another"><?php echo $gameData->next_prc_1; ?></td>
            <td><?php echo $gameData->next_ctr_2; ?></td>
            <td class="check-another"><?php echo $gameData->next_prc_2; ?></td>
            <td><?php echo $gameData->next_ctr_3; ?></td>
            <td class="check-another"><?php echo $gameData->next_prc_3; ?></td>
            <td><?php echo $gameData->next_ctr_4; ?></td>
            <td class="check-another"><?php echo $gameData->next_prc_4; ?></td>
        </tr>
        <?php endforeach; ?>
